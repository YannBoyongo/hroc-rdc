<x-app-layout>
    ...
    <div class="space-y-6">
        ...
        <div class="flex justify-between items-center">
            <h2 class="text-2xl font-bold text-deep_twilight-500">Liste des objectifs</h2>
            ...
            <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{{ $objective->id }}</td>
                            <td class="px-6 py-4">
                                <div class="text-sm font-medium text-deep_twilight-500">{{ $objective->name }}</div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                <div class="flex justify-end gap-2">
                                    <a href="{{ route('admin.objectives.edit', $objective) }}" 
                                       class="text-blue_green-600 hover:text-blue_green-900">
                                        {{ __('Modifier') }}
                                    </a>
                                    <form action="{{ route('admin.objectives.destroy', $objective) }}" 
                                          method="POST" 
                                          class="inline"
                        ...
                        <tr>
                            <td colspan="3" class="px-6 py-4 text-center text-gray-500">
                                Aucun objectif trouvé. <a href="{{ route('admin.objectives.create') }}" class="text-blue_green-600 hover:underline">Créer le premier</a>
                            </td>
                        </tr>
                        @endforelse
                    </tbody>
