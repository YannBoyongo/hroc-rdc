<x-app-layout>
    ...
    <div class="space-y-6">
        ...
        <div class="flex justify-between items-center">
            <h2 class="text-2xl font-bold text-deep_twilight-500">Liste des domaines</h2>
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    <thead class="bg-gray-50">
                        <tr>
                            ...
                            <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Descriptions</th>
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{{ $domain->id }}</td>
                            <td class="px-6 py-4">
                                <div class="text-sm text-deep_twilight-500 line-clamp-3">{{ Str::limit($domain->descriptions, 200) }}</div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                <div class="flex justify-end gap-2">
                                    ...
                                    <form action="{{ route('admin.domains.destroy', $domain) }}" 
                                          method="POST" 
                                          class="inline"
                        ...
                        <tr>
                            <td colspan="3" class="px-6 py-4 text-center text-gray-500">
                                Aucun domaine trouvé. <a href="{{ route('admin.domains.create') }}" class="text-blue_green-600 hover:underline">Créer le premier</a>
                            </td>
                        </tr>
                        @endforelse
                    </tbody>
