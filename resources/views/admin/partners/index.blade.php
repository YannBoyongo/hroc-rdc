<x-app-layout>
    ...
    <div class="space-y-6">
        ...
        <div class="flex justify-between items-center">
            <h2 class="text-2xl font-bold text-deep_twilight-500">Liste des partenaires</h2>
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr>
                            <td class="px-6 py-4 whitespace-nowrap">
                                @if($partner->image)
                                    <img src="{{ Storage::url($partner->image) }}" alt="{{ $partner->title }}" class="h-16 w-24 object-cover rounded">
                                @else
                            ...
                            <td class="px-6 py-4">
                                <div class="text-sm font-medium text-deep_twilight-500">{{ $partner->title }}</div>
                            </td>
                        ...
                        <tr>
                            <td colspan="3" class="px-6 py-4 text-center text-gray-500">
                                Aucun partenaire trouvé. <a href="{{ route('admin.partners.create') }}" class="text-blue_green-600 hover:underline">Créer le premier</a>
                            </td>
                        </tr>
                        @endforelse
                    </tbody>
